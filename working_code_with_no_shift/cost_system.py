...
cost_system.py
==============
Business cost model for the call centre simulation.
No logic changes from original — just compatible with fixed core_simulation.py.
"""
...
class CostConfig:
    ...
    burnout_fatigue_threshold: float = 0.70
    burnout_incident_cost:     float = 1500.00
    burnout_productivity_drag: float = 10.00
    burnout_attrition_prob:    float = 0.05
    burnout_replacement_cost:  float = 1500.00
...
# ---------------------------------------------------------------------------
# CostAwareKPIEngine — wires cost ledger into KPI event flow
# ---------------------------------------------------------------------------
